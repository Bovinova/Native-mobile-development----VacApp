...
fun HomeView(
    ...
    Column(
        ...
        Card(
                modifier = Modifier.width(365.dp).height(120.dp),
        ...
        Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
            Row(horizontalArrangement = Arrangement.spacedBy(15.dp)) {
                Card(
                        modifier = Modifier.width(165.dp).height(120.dp),
                        shape = RoundedCornerShape(5.dp),
                        colors =
                                CardDefaults.cardColors(
                                        containerColor = Color.AlmondCream,
        ...
        Box(modifier = Modifier.fillMaxWidth().padding(horizontal = 25.dp)) {
            ...
            if (isButtonActive.value) {
                Popup(alignment = Alignment.TopEnd, offset = IntOffset(-75, -355)) {
                    Column(
                            modifier = Modifier.background(Color.AlmondCream).padding(10.dp),
